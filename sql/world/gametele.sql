...
-- Dumping structure for table freshworlddb.game_tele
-- Stelle sicher, dass die richtige Datenbank genutzt wird
USE `acore_world`;

-- Falls eine alte Version existiert, werfen wir sie weg, um Konflikte zu vermeiden
DROP TABLE IF EXISTS `game_tele`;

-- Erstellung der Tabelle nach aktuellem AzerothCore-Standard
CREATE TABLE `game_tele` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COMMENT='Tele Command';

-- Daten einfügen (Bereinigt um die fehlerhafte 'security'-Spalte)
INSERT INTO `game_tele` (`id`, `position_x`, `position_y`, `position_z`, `orientation`, `map`, `name`) VALUES
	...
	(1425, 16202.2, 16256.5, 21.1869, 6.07893, 1, 'wyspa'),
	(1427, 16227.8, 16403.4, -64.3804, 3.13604, 1, 'Minastirisland'),
	(1428, -4819.67, -975.082, 464.709, 3.79802, 0, 'Minastirjaskinia'),
